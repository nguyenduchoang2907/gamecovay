...
// Xử lý REPLAY khi có message từ socket
...
void HistoryItemWidget::onMessageReceived(QString msgtype, QString payload) {
    if (msgtype == "REPLAY") {
        ...
        MainWindow *w = MainWindow::getInstance();        // Mở cửa sổ Replay với các tham số tương ứng
...
//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