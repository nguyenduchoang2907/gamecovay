...
LoginWindow::LoginWindow(QWidget *parent)
    : QMainWindow(parent)// Hàm khởi tạo của cửa sổ đăng nhập, kế thừa từ QMainWindow
    , ui(new Ui::LoginWindow)// Khởi tạo đối tượng UI của cửa sổ đăng nhập
{
    ui->setupUi(this);// Khởi tạo đối tượng UI của cửa sổ đăng nhập

        // Khởi tạo socket và kết nối các sự kiện với xử lý tương ứng
